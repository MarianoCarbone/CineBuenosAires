...
$sql="SELECT*FROM registros WHERE id_usuario=$id";
...
<body>
            ...
            <div class="d-flex">
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" style="color: gray;" href="formemail.php">Contáctenos</a>
                  </li>
                  <li class="nav-item">
    ...
    <div class="d-flex justify-content-center">
        <div class="col-sm-6  ">
            <form action="actualizar.php" class="row g-3 m-5 p-2" method="POST">
                <!--nombre y apellido-->
                <div class="col-md-6 col-sm-6 col-lg-6 p-1">
                    <input type="text" class="form-control" placeholder="Nombre" value="<?php echo $fila['nombre'];?>" name=nombre>
                </div>
                <div class="col-md-6 col-sm-6 col-lg-6 p-1">
                    <input type="text" class="form-control" placeholder="Apellido" value="<?php echo $fila['apellido'];?>" name=apellido>
                </div>
                <!--DNI y telefono-->

                <div class="col-md-6 col-sm-6 col-lg-6 p-1">
                    <input type="text" class="form-control" placeholder="Dni" value="<?php echo $fila['dni'];?>" name=dni>
                </div>
                <div class="col-md-6 col-sm-6 col-lg-6 p-1">
                    <input type="text" class="form-control" placeholder="Telefono" value="<?php echo $fila['telefono'];?>" name=telefono>
                </div>
                <!--correo-->
                <div class="col-md-12 col-sm-12 col-lg-12 p-1">
                    <input type="email" class="form-control" placeholder="Correo" value="<?php echo $fila['email'];?>" name=email>
                </div>
                <!--password-->
                
                <div class="col-md-12 col-sm-12 col-lg-12 p-1">
                    <input type="password" class="form-control" placeholder="password" value="<?php echo $fila['password'];?>" name=password>
                </div>
            ...
            <footer> 
                ...
                <div class="d-flex justify-content-center">
                  <div class="foot">
                    ...
                    <div class="c2">
                      <a style="color:white; text-decoration: unset;" href="formemail.php">Contáctenos</a>
                    </div>
